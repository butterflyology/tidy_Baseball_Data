...
Batting.new <- inner_join(Batting, AB.totals, by = "playerID")
head(Batting.new) # Adds the Career.AB column by player
dim(Batting.new)

Batting.2000 <- Batting.new %>% filter(Career.AB >= 2000)
head(Batting.2000)
dim(Batting.2000)
...
Data.2000 <- inner_join(Batting.2000, Fielding.2000, by = "playerID")
head(Data.2000)
dim(Data.2000)
...
```{r Sec_8.3.2}
C.totals <- Data.2000 %>% group_by(playerID) %>% summarize(
...
Batting.2000a <- Data.2000 %>%
  group_by(playerID, yearID) %>%
  collapse.stint
head(Batting.2000a)
dim(Batting.2000a)

player.list <- as.character(unique(Batting.2000a$playerID))
...
Batting.2000c <- inner_join(Batting.2000a, as_data_frame(x = list(playerID = player.list, Birthyear = birthyears)), by = "playerID")

# setequal(Batting.2000b, Batting.2000c)
  

Batting.2000c <- Batting.2000c %>%
...
Batting.2000c[complete.cases(Batting.2000c$Age), ]
```
...
player.list <- as.character(similar(pid, n.similar)$playerID)

Batting.new <- subset(Batting.2000c, playerID %in% player.list)
